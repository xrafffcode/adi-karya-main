    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Purwojati, Banyumas</p>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <a class="btn btn-link" href="">Produk Kami</a>
                <a class="btn btn-link" href="">Bantuan</a>
            </div>
            <div class="col-lg-3 col-md-6">
                <h4 class="text-light mb-4">Dapatkan Promosi</h4>
                <p>Dapatkan promosi terbaru dari kami.</p>
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="/">Adi Karya</a>, All Right Reserved.
                </div>
            </div>
        </div>
    </div>
